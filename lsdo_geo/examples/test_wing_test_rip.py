...
path_name = 'lsdo_geo/Geometry/CAD/'
...
rib_top_curve, pts_top_curve = geo.project_curve(np.linspace(np.array([0.04,0.5,0.03]),np.array([0.2 ,0.5,0.03]), num_pts1), projection_direction=direction)
direction = np.array([0., 0., 1.])
rib_bot_curve, pts_bot_curve = geo.project_curve(np.linspace(np.array([0.04,0.5,-0.02]),np.array([0.2 ,0.5,-0.02]), num_pts1), projection_direction=direction)
