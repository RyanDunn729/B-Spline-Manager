...
path_name = 'CAD/'
file_name = 'eVTOL.stp'
geo = Geometry(path_name + file_name, plot=True)
...
primary_spar_top_curve, test_bot_pri_spar = geo.project_curve(primary_spar_top, top_wing_surface_names, offset=np.array([0., 0., eps1]), plot=True, projection_direction = down_direction)
...
primary_spar_bot_curve, test_bot_pri_spar = geo.project_curve(primary_spar_bot, bot_wing_surface_names, offset=np.array([0., 0., -eps1]), plot=True, projection_direction = up_direction)
...
rear_spar_top_curve, test_bot_pri_spar = geo.project_curve(rear_spar_top, top_wing_surface_names, offset=np.array([0., 0., eps1]), plot=True, projection_direction = down_direction)
...
rear_spar_bot_curve, test_bot_pri_spar = geo.project_curve(rear_spar_bot, bot_wing_surface_names, offset=np.array([0., 0., -eps1]), plot=True, projection_direction = up_direction)
...
for i in range(num_ribs):
    ...
    rib_top_curve, test_top_rib = geo.project_curve(rib_top, top_wing_surface_names, offset=np.array([0., 0., eps1]), plot=True, projection_direction = down_direction)
    
    rib_bot = np.linspace(primary_spar_bot[i]-eps2, rear_spar_bot[i]+eps2, num_pts_ribs_top_bot)
    rib_bot_curve, test_bot_rib = geo.project_curve(rib_bot, bot_wing_surface_names, offset=np.array([0., 0., -eps1]), plot=True, projection_direction = up_direction)
