...
def read_openvsp_stp(geo, file_name):
        ...
        with open(file_name, 'r') as f:
            ...
            for i, surf in enumerate(b_spline_surf_info):
                ...
                parsed_info[0] = parsed_info[0]+f', {i}'
        ...
        for i in range(num_surf):
            ...
            if np.sum(parsed_info_dict[f'surf{i}_u_multiplicities'][1:-1]) != len(parsed_info_dict[f'surf{i}_u_multiplicities'][1:-1]) \
                ...
                #geo.input_bspline_entity_dict[parsed_info_dict[f'surf{i}_name']] = geo.remove_multiplicity(geo.input_bspline_entity_dict[parsed_info_dict[f'surf{i}_name']])
                #if i == 44 or i == 52 or i == 60 or i==61:
                    #continue
                #pass
