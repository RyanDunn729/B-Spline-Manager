...
def create_ffd(control_points, nxp, nyp, nzp):
    ...
    return bot_top_lines, section_mesh, ffd_control_points
...
if __name__ == "__main__":
    ...
    point010 = np.array([130., 100., 100.])
    point011 = np.array([130., 100., 170.])
    ...
    point110 = np.array([200. ,100. ,100.])
    point111 = np.array([200. ,100. ,170.])
    ...
    control_points = np.zeros((3, 3, 3, 3))
    ...
    bot_top_lines, section_mesh, ffd_control_points = create_ffd(control_points, nxp, nyp, nzp)
